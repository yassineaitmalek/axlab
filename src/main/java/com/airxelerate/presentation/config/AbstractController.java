...
public interface AbstractController {
        ...
        public default <T> ResponseEntity<ApiDataResponse<T>> async(
                        Runnable runnable, Supplier<T> supplier) {
                runnable.run();
        ...
        public default ResponseEntity<StreamingResponseBody> downloadLarge(
                        ApiDownloadInputLarge apiDownloadInput) {
                return ResponseEntity.status(HttpStatus.OK)
                                .header("Content-Type", "application/octet-stream")
                                .header("Content-Disposition",
                                                "attachment; filename=" + apiDownloadInput.getValidName())
        ...
        public default ResponseEntity<ApiExceptionResponse> internalException(
        ...
        public default ResponseEntity<ApiExceptionResponse> forbidden(
                        Exception exception, WebRequest request) {
        ...
        public default ResponseEntity<ApiExceptionResponse> badRequest(
                        Exception exception, WebRequest request) {
        ...
        public default ResponseEntity<ApiExceptionResponse> badRequest(String message,
                        Exception exception, WebRequest request) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                .body(
                                                ApiExceptionResponse.builder()
        ...
        public default ResponseEntity<ApiExceptionResponse> notFound(
                        Exception exception, WebRequest request) {
        ...
        public default ResponseEntity<ApiExceptionResponse> tooManyRequests(
                        Exception exception, WebRequest request) {
