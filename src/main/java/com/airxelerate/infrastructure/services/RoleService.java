...
import com.airxelerate.persistence.repositories.RoleRepository;
...
public class RoleService {
    ...
    public List<Role> getRoles(List<String> rolesName) {
        ...
        return Stream.of(Arrays.asList(REGULAR_USER), Optional.ofNullable(rolesName).orElseGet(Collections::emptyList))
                .flatMap(List::stream)
