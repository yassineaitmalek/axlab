package com.airxelerate.common.utility;
...
public class DateUtility {
  ...
  public static LocalDate recentDate(List<LocalDate> dates, LocalDate defaultDate) {
    return dates.stream().filter(Objects::nonNull).reduce(DateUtility::recentDate).orElseGet(() -> defaultDate);
  }
  ...
  public static LocalDate oldestDate(List<LocalDate> dates, LocalDate defaultDate) {
    return dates.stream().filter(Objects::nonNull).reduce(DateUtility::oldestDate).orElseGet(() -> defaultDate);
  }
